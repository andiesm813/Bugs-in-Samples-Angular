...
const routes: Routes = [{ path: '', component: MasterViewComponent, children: [{ path: '', redirectTo: 'buttons', pathMatch: 'full' }, { path: 'buttons', component: ButtonsComponent, data: { text: 'Buttons' } }, { path: 'button-styles', component: ButtonStylesComponent, data: { text: 'Button Styles' } }, { path: 'button-group', component: ButtonGroupComponent, data: { text: 'Button Group' } }, { path: 'space-between', component: SpaceBetweenComponent, data: { text: 'Space Between' } }, { path: 'cards-opacity', component: CardsOpacityComponent, data: { text: 'Cards Opacity' } }, { path: 'card-actions', component: CardActionsComponent, data: { text: 'Card Actions' } }, { path: 'chips', component: ChipsComponent, data: { text: 'Chips' } }, { path: 'dialog', component: DialogComponent, data: { text: 'Dialog' } }, { path: 'grid-in-tab-layout', component: GridInTabLayoutComponent, data: { text: 'Grid in Tab Layout' } }, { path: 'inputs-combos', component: InputsCombosComponent, data: { text: 'Inputs & Combos' } }] }];
